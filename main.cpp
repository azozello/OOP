...
int main() {
    string anyKey,info,name,job,group,surname;
    int number, year;
    bool sex;
    float salary;
    ...
    while (true){
        ...
        cout<<"Enter 5 to remove student"<<endl;
        cout<<"Enter 6 to change student`s room"<<endl;
        ...
        switch (flag){
            ...
            case 3:
                ...
                cin>>name;
                cout<<"Enter staff`s surname:   "<<endl;
                cin>>surname;
                    ...
                    case 1:
                        ...
                        for (int i = 0; i < staffVector.size(); ++i) {
                            cout<<"Name: "<<staffVector[i].getName()
                                <<"   Surname: "<<staffVector[i].getSurname()
            ...
            case 5:
                ...
                cout<<"Enter surname: "<<endl;
                cin>>surname;
                hostel->removeStudent(name,surname);
                students = hostel->loadStudents();
                break;
            case 6:
                cout<<"Enter name: "<<endl;
                ...
                cin>>number;
                hostel->changeRoom(name,surname,number);
                students = hostel->loadStudents();
                break;
        }
    }
